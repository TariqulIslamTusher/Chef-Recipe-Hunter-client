    ...
    return (
        <div>
            ...
            <div className="card hover:-translate-y-3 transition-all duration-200 w-full bg-base-100 shadow-xl image-full">
                <figure>
                    <img loading='lazy' className='w-full min-h-[450px] object-cover object-center' src={imgRec} alt="Shoes" />
                </figure>
                <div className="card-body">
                    ...
                    <div className='bg-yellow-800 bg-opacity-40 p-2 text-center rounded-lg'>
